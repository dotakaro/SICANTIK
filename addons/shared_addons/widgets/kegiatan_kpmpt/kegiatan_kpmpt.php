 ...
 */
class Widget_Kegiatan_kpmpt extends Widgets
{
	...
	public $title = array(
		...
		'ru' => 'Последние записи',
		'id' => 'Post Kegiatan KPMPT Terbaru',
	);
	...
	public $description = array(
		...
		'id' => 'Menampilkan posting info kegiatan KPMPT terbaru menggunakan widget',
	);
	...
	public function run($options)
	{
		...
		$blog_widget = $this->db->query(
                        "SELECT a.id,a.title,a.slug,a.created,a.updated,a.intro,a.status,a.thumb_image,a.created_on,a.updated_on FROM default_blog a 
                            INNER JOIN default_blog_categories b ON a.category_id=b.id 
                            WHERE b.slug='kegiatan-kpmpt' AND a.status='live'
