 ...
 */
class Widget_Link_website extends Widgets
{
	...
	public $title = array(
		...
		'ru' => 'Последние записи',
		'id' => 'List Link Website',
	);

	public $description = array(
		'en' => 'Display website links',
		...
		'id' => 'Menampilkan daftar link website',
	);
	...
	public function run($options)
	{
		...
		$blog_widget = $this->db->query(
                        "SELECT  * FROM default_link_website 
                            ORDER BY nama_link ASC
