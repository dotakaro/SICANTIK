 ...
 */
class Widget_Info_publik extends Widgets
{
	...
	public $description = array(
		...
		'id' => 'Menampilkan posting info publik terbaru menggunakan widget',
	);
	...
	public function run($options)
	{
		...
		$blog_widget = $this->db->query(
                        "SELECT a.* FROM default_blog a 
                            ...
                            WHERE b.slug IN('informasi','kegiatan-kpmpt') AND a.status='live'
