...
class Theme_Portal_kominfo extends Theme {

    public $name			= 'Portal Kominfo Theme';
    public $author			= 'Indra';
    public $author_website	= 'http://indra.com';
    public $website			= 'http://indra.com/';
    public $description		= 'Default Portal v1.0 Theme - 2 Column, Fixed width, Horizontal navigation, CSS3 styling.';
