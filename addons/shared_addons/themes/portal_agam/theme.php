...
class Theme_Portal_agam extends Theme {

    public $name			= 'Portal AGAM Theme';
    public $author			= 'Efendi';
    public $author_website	= 'http://Efendi.com';
    public $website			= 'http://Efendi.com/';
    public $description		= 'Default Agam v1.0 Theme - 2 Column, Fixed width, Horizontal navigation, CSS3 styling.';
