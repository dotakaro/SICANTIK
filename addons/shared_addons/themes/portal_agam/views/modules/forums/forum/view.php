<div class="forum_buttons">
    <?php echo anchor('forums/topics/new_topic/'.$forum->id, ' New Topic ',"class='button' style='background-color:rgb(90, 158, 37)'");?>
    <br clear="both" />
</div>
...
<table class="forum_table" border="0" cellspacing="0">
    <thead>
        <tr>
            <th colspan="5"><div class="block-title"><?php echo $forum->title;?></div></th>
        </tr>
        <tr class="header">
            <th width="2%">&nbsp;</th>
