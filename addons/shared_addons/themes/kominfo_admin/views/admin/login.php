...
<head>
    ...
    <style>
        #login-logo {
            background-image: url("<?php echo base_url();?>files/thumb/<?php echo get_portal_theme('logo_instansi');?>/120x150/fit");
        }
    </style>
...
<div id="container" class="login-screen">
	<section id="content">
		<div id="content-body">
			...
			<div class="animated" id="login-logo"></div>
...
<footer id="login-footer">
	<div class="wrapper animated fadeIn" id="login-credits">
		Copyright &copy; <?php echo date('Y'); ?> Batra.
	</div>
</footer>
