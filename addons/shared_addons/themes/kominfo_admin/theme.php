...
class Theme_Kominfo_admin extends Theme
{

    public $name = 'Kominfo';
    public $author = 'Indra';
    public $author_website = 'http://indra.com/';
    public $website = 'http://indra.com/';
    public $description = 'Kominfo admin theme. HTML5 and CSS3 styling.';
    public $version = '1.0.0';
    public $type = 'admin';
    public $options = array('portal_recent_comments' => array('title' => 'Recent Comments',
        ...
        'portal_news_feed' => array('title' => 'News Feed',
        ...
        'portal_quick_links' => array('title' => 'Quick Links',
        ...
        'portal_analytics_graph' => array('title' => 'Analytics Graph',
    ...
    public function run()
    {
        ...
        if ($this->module == '' && $this->method != 'login' && $this->method != 'help') {
            ...
            if ($this->theme_options->portal_analytics_graph == 'yes') self::get_analytics();
            if ($this->theme_options->portal_news_feed == 'yes') self::get_rss_feed();
            if ($this->theme_options->portal_recent_comments == 'yes') self::get_recent_comments();
        }
    }
