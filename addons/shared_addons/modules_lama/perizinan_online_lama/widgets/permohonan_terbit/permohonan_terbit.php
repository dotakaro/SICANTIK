...
/**
 * Widget untuk menampilkan daftar permohonan yang sudah berada para proses cetak izin
 *(semua izin yang sudah berada pada proses cetak izin pada back office)
 ...
 */
class Widget_Permohonan_terbit extends Widgets
{
	...
	public $title = array(
		'en' => 'Daftar Permohonan yang Diterbitkan',
		'id' => 'Daftar Permohonan yang Diterbitkan',
	);
