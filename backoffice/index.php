...
error_reporting(0); ini_set("display_errors", 0); //karena ada warning saat di php 5.3.10
...
//Path To Barcode
define('BCPATH', $barcode_folder . '/');
//Full path to barcode
define('FULLBCPATH', str_replace(SELF, '', __FILE__) . $barcode_folder . '/');
