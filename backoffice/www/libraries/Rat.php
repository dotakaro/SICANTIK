...
class Rat
{
     ...
     * log something
     */
    public function log($message, $code = 0, $user_id = 0, $tmpermohonan = 0)
    {
        ...
        if($this->_set_message($message,$user_id,$code,$tmpermohonan))
        {
            return TRUE;
        }
        else
    ...
    public function delete_log($user_id = NULL, $date = NULL, $tmpermohonan = NULL)
    {
    ...
    private function _set_message($message,$user_id,$code,$tmpermohonan)
    {
