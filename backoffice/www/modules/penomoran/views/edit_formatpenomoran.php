					...
					<div id="rightRail" class="bg-grid">
						...
						<?php
							foreach ($perizinan as $row){
								if($row->id == $list->id_perizinan)
									echo "<option value=".$row->id." selected='selected'>".$row->n_perizinan."</option>";
								else
					...
					<div id="rightRail">
						...
						<?php
							foreach ($jenis_permohonan as $row =>$index){
								if($row == $list->id_jenis)
									echo "<option value=".$row." selected='selected'>".$index."</option>";
								else
