...
t3.n_perizinan,
t1.a_izin,
if(t5.n_pemohon IS NULL, b.n_pemohon, t5.n_pemohon) AS n_pemohon,
t13.n_permohonan,
t7.n_sts_permohonan,
t1.id,
t11.n_perusahaan
...
LEFT JOIN tmperusahaan_sementara AS d ON d.id = c.tmperusahaan_sementara_id
    ...
    function get_list_infotracking(){
        ...
        if ($sSearch != NULL){
            $colum=array("t1.pendaftaran_id", "t3.n_perizinan","t1.a_izin", "t5.n_pemohon","t11.n_perusahaan", "t13.n_permohonan" ,"t7.n_sts_permohonan");
