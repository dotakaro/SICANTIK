                    ...
                    <div id="tabs-2">
                        ...
                        <div id="contentleft">
                            ...
                            <div class="contentForm">
								...
								//print_r ($cek_bpjs);
                                if ($cek_bpjs > "0"){
									echo form_label('Cek BPJS Ketenagakerjaan ');
								} else {
								...
								<?php if ($cek_bpjs =="1"){ ?>
									<br>
                                    <input id="cek_bpjs" type="button" value="Cek BPJS" >
								<?php } ?>
                            </div>
                        ...
                        <table cellpadding="0" cellspacing="0" border="1" class="display">
                            <thead>
                                <tr>
									...
									$upload = $jenis_izin->c_upload;
									
									if ($upload == "1"){
									?>
									<th width="5%" style="text-align: center;padding-left:0px;">Terpenuhi</th>
									<th width="5%" style="text-align: center;padding-left:0px;">Upload Berkas</th>
									<?php
									}else{
									?>
									<th width="5%" style="text-align: center;padding-left:0px;">Terpenuhi</th>
