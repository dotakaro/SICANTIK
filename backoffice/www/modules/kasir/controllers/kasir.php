...
WHERE A.c_pendaftaran = 1
    ...
    public function edit($id = NULL) {
		...
		$data_status = new tmpermohonan_trstspermohonan();
		$data_status->where('tmpermohonan_id',$this->permohonan->id);
		$data_status->trstspermohonan_id;
		...
		$data['namaperusahaan'] = $this->permohonan->tmperusahaan->n_perusahaan;
    ...
    public function save() {
		...
		$this->rat->log('Bayar',8,$this->session->userdata('id_auth'),$id_permohonan);
