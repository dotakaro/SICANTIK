...
//            $this->_check_auth();
    ...
    public function save(){
        ...
        $nilai_retribusi = floor($this->input->post('nilai_retribusi'));
        ...
        if(! $this->retribusi->save()) {
			...
			$this->rat->log('Hitung Retribusi senilai '.$nilai_retribusi,9,$this->session->userdata('id_auth'),$id_permohonan);
