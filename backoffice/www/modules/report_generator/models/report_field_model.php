<?php
class Report_field_model extends Model{
    private $_table="report_fields";
...
//		echo "<pre>";print_r($datas);exit();
	...
	public function delete($report_field_id=null){
		$result=false;
		if($report_field_id){
			$this->db->where('id',$report_field_id);
	...
	function get_all_report_field($report_group_data_id=null, $report_generator_id=null){
		$data=array();
		$ret=array();
		$count=0;	
		if($report_group_data_id){
