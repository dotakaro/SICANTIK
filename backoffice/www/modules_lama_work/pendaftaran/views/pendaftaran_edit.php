                ...
                <fieldset>
                    ...
                    <div id="statusRail">
                        ...
                        <div id="rightRail">
                            ...
                            ?>
                            <input type="hidden" value="<?php echo $tgl_survey; ?>" name="txttglselesai"
                                   id="txttglselesai"/>
                            <input type="hidden" value="<?php echo $tglambil_izin; ?>" name="tglambil_izin"
                                   id="tglambil_izin"/>
                            ...
                            <div class="contentForm">
                                <b><?php
                                    ...
                                    if ($kecamatan_usaha == NULL) {
                                        ...
                                        echo "<div id='show_kecamatan_usaha'><input type='hidden' value='" . $kecamatan_usaha . "' name='kecamatan_usaha' />" . $nama_kecamatan_usaha . "</div>";
                                    }
                                    ?>
                            </div>
                            <div style="clear: both"></div>
                            <div class="contentForm">
                                <b><?php
                                    ...
                                    if ($kelurahan_usaha == NULL) {
                                        ...
                                        echo "<div id='show_kelurahan_usaha'><input type='hidden' value='" . $kelurahan_usaha . "' name='kelurahan_usaha' />" . $nama_kelurahan_usaha . "</div>";
                                    }
                                    ?>
                            </div>
                                        ...
                                        <td align="center">
                                            ...
                                            if ($save_method === 'update') {
                                                if (isset($existingSyaratPerizinan[$data->id])) {//Jika ada data Syarat dengan Key trsyarat_perizinan_id
                                                    ...
                                                    $txtAkhirBerlaku['value'] = $existingSyaratPerizinan[$data->id]['tgl_akhir_berlaku'];
                                                } else {
