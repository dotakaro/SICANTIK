...
<div id="content">
    <div class="post">
        ...
        echo form_open('mobile_pemohon/' . $save_method, $attr);
        ...
        <div class="entry">
            <div id="tabs">
                <ul>
                    ...
                    <li><a href="#tabs-2">Data User</a></li>
                </ul>
                <div id="tabs-1">
                    <div id="contentleft">
                ...
                <div id="tabs-2">
                    <div id="contentleft">
                        <div class="contentForm">
                            <?php
                            echo form_hidden('mobile_user_id', $mobile_user_id);
                            echo '<b>' .form_label('Username') . '</b>';
                            echo $mobile_username;
                            ?>
                        </div>
                        <div style="clear: both" ></div>
                        <div class="contentForm">
                            <?php
                            $optActive = array(0 => 'Tidak Aktif',1 => 'Aktif');
                            echo '<b>' .form_label('Status') . '</b>';
                            echo form_dropdown('active',$optActive,$active,'class = "input-select-wrc" id="active"');
                            ?>
                        </div>
                        <div style="clear: both" ></div>
                        <div class="contentForm">
                            <?php
                            echo '<b>' .form_label('Login Terakhir') . '</b>';
                            echo $last_login;
                            ?>
                        </div>
                        <div style="clear: both" ></div>
        ...
        <div class="entry" style="text-align: center;">
            ...
            $cancel_daftar = array(
                ...
                'class' => 'button-wrc',
                'content' => 'Batal',
                'onclick' => 'parent.location=\'' . site_url('mobile_pemohon') . '\''
            );
