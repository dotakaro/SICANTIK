  ...
  $list_status = $stspermohonan->where('id',$idizin)->get();
        ...
        $listeArticles3 = array(
                array(	'property' =>  $i,
						...
						'content8' =>  $data_relasi->telp_pemohon,
						'content9' =>  $data_relasi->n_perusahaan,
						'content10' =>  $data_relasi->no_surat,
						'content11' =>  $data_relasi->tgl_surat
			...
			foreach($listeArticles3 AS $element) {
               ...
               //$article3->texteArticle5($element['content3']);
				...
				$article3->texteArticle10($element['content8']);
				$article3->texteArticle11($element['content9']);
				$article3->texteArticle12($element['content10']);
				$article3->texteArticle13($element['content11']);
                $article3->merge();
        }
	...
	$sOutput .= '"aaData": [ ';
        ...
        foreach($lists as $list) {
			...
			$sOutput .= '"'.$list->tmpemohon->telp_pemohon. '"';
            $sOutput .= "],";
        }
...
INNER JOIN tmpermohonan_tmsk ON a.id = tmpermohonan_tmsk.tmpermohonan_id
INNER JOIN tmsk ON tmsk.id = tmpermohonan_tmsk.tmsk_id
INNER JOIN tmpermohonan_tmperusahaan ON a.id = tmpermohonan_tmperusahaan.tmpermohonan_id
