            ...
            <fieldset id="half">
                ...
                <div class="contentForm" id="show_jenis_izin">
                    <?php
                        ...
                        echo form_dropdown('jenis_izin_id', $opsi_izin, '','class = "input-select-wrc required" id="jenis_izin"');
                    ?>
                </div>
                <div class="contentForm bg-grid">
                    ...
                    echo form_dropdown('trunitkerja_id', $opsiUnitKerja, '','class = "input-select-wrc required" id="unit_kerja"');
                    ?>
                </div>
                <div class="contentForm">
                    <?php
                        ...
                        echo '<b>' . form_label('Nomor Izin Lama ') . '</b>';
                        echo form_input($no_izin);
                        echo form_error('no_izin', '<div class="field_error">', '</div>');
                    ?>
                </div>
                <div class="contentForm bg-grid">
                    <?php
                        $data = array('1' => 'PERMOHONAN BARU','2' => "PERMOHONAN PERUBAHAN",'3' => 'PERMOHONAN PERPANJANGAN', '4' => 'PERMOHONAN DAFTAR ULANG');
                        echo '<b>' .form_label('Jenis Permohonan') . '</b>';
                        echo form_dropdown('jenis_permohonan_id',$data,'','class = "input-select-wrc required" id="cmbsource1"');
                ...
                <div class="contentForm">
                    <?php
                        ...
                        echo '<b>' . form_label('Tgl Izin Lama ') . '</b>';
                        echo form_input($tglizin);
                        echo form_error('tglizin', '<div class="field_error">', '</div>');
                    ?>
                </div>
                <div class="contentForm bg-grid">
                    <?php
                        ...
                        echo '<b>' . form_label('Tgl Berlaku Izin Lama ') . '</b>';
                        echo form_input($tglberlaku);
                        echo form_error('tglberlaku', '<div class="field_error">', '</div>');
                    ?>
                </div>
            </fieldset>
        </div>
