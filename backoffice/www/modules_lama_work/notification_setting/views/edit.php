...
<div id="content">
    <div class="post">
        ...
        $hidden_setting_notifikasi_id = array(
            ...
            'type'=>'hidden',
            'value'=>$perizinan->setting_notifikasi->id
        );
        ...
        <div class="entry">
            <fieldset id="half">
                ...
                <!--<div id="statusRail">
                    ...
                    <div id="rightRail">
                        <?php /*echo form_dropdown("tipe_notifikasi", $list_tipe_notifikasi, $setting_notifikasi->tipe_notifikasi,' class="input-select-wrc required-option"');*/?>
                    </div>
                </div>-->
            </fieldset>
                ...
                <div id="tabs-<?php echo $key;?>">
                    <div id="tabs-horizontal-<?php echo $key;?>" class="tabs-horizontal">
                        ...
                        <div id="tabs-horizontal-<?php echo $key;?>-1">
                            ...
                            $penerima_lain = "";
                            $detail_id = null;
                            $tipe_notifikasi = 'sms';//Default ke sms
                            if(array_key_exists($status_permohonan->id,$list_notifikasi_detail)){
                                $format_pesan = $list_notifikasi_detail[$status_permohonan_id]['format_pesan'];
                                $detail_id = $list_notifikasi_detail[$status_permohonan_id]['id'];
                                $penerima_lain = $list_notifikasi_detail[$status_permohonan_id]['penerima_lain'];
                                $tipe_notifikasi = $list_notifikasi_detail[$status_permohonan_id]['tipe_notifikasi'];
                            }

                            $hidden_detail_id = array(
                                'name' => 'SettingNotifikasiDetail['.$index.'][id]',
                                'value' => $detail_id,
                                'type'=>'hidden',
                                'id'=>'SettingNotifikasiDetail'.$index.'Id'
                            );
                            ...
                            echo form_input($hidden_detail_id);
                            echo form_input($hidden_trstspermohonan_id);
                            echo form_input($hidden_tujuan_notifikasi);
                            echo 'Tipe Notifikasi';
                            echo '<br style="clear: both" />';
                            echo form_dropdown("SettingNotifikasiDetail[$index][tipe_notifikasi]", $list_tipe_notifikasi, $tipe_notifikasi,' class="input-select-wrc required-option"');
                            echo '<br>';
                            echo 'Format Pesan';
                            echo '<br style="clear: both" />';
                        ...
                        <div id="tabs-horizontal-<?php echo $key;?>-2">
                            ...
                            $detail_id = null;
                            $tipe_notifikasi = 'sms';//default ke sms
                            if(array_key_exists($status_permohonan->id,$list_notifikasi_detail_petugas)){
                                $format_pesan = $list_notifikasi_detail_petugas[$status_permohonan_id]['format_pesan'];
                                $detail_id = $list_notifikasi_detail_petugas[$status_permohonan_id]['id'];
                                $penerima_lain = $list_notifikasi_detail_petugas[$status_permohonan_id]['penerima_lain'];
                                $tipe_notifikasi = $list_notifikasi_detail_petugas[$status_permohonan_id]['tipe_notifikasi'];
                            }
