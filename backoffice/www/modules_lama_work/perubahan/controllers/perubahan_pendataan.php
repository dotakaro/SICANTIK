...
class perubahan_pendataan extends WRC_AdminCont {

    private $_status_entry_data = 0;//no
...
//        }
        ...
        $this->load->vars($data);
        $this->session_info['page_name'] = "Edit Data Pendataan";
        $this->template->build('pendataan_edit', $this->session_info);
    }
...
//          $jam = date("H:i:s A");
            ...
            redirect('pelayanan/perubahan/pendataan');
        }                
    }
