...
<!--                    <li><a href="#tabs-2">Data Surat Rekomendasi</a></li>-->
                ...
                <div id="tabs-1">
                    ...
                    <?php
                        $i = 0;
                        $z = 0;
                        $printed_parent = array();//Daftar Parent yang sudah diprint, agar tidak 2 kali print
                            ...
                            if($list_daftar->id){
                                ...
                                foreach ($list_daftar as $data_daftar){
                                    ...
                                    if($entry_property->tmproperty_jenisperizinan_id){
                                        ...
                                        $entry_daftar
                                                //->get_by_id($entry_property->tmproperty_jenisperizinan_id);
                                                ->where('entry_flag',2)
                                                ->where('tim_teknis_id', $tim_teknis_id)
                                                ->where('id',$entry_property->tmproperty_jenisperizinan_id)
                                                ->get();
                                        ...
                                        $entry_id = $data_daftar->id;
                                        $data_entry = $data_daftar->v_tinjauan;
                                        $data_koefisien = $data_daftar->k_tinjauan;
                                        $data_entry2 = $data_daftar->v_property;
                                        $data_koefisien2 = $data_daftar->k_property;        
                                        #############
...
//                            }
                                        ...
                                        //Jika ada mapping unitkerja ke property
                                        if(!empty($mapping_unitkerja)){
                                            if(
                                                //Jika unit kerja dari parent property tidak sesuai dengan user yang login
                                                //(isset($mapping_unitkerja[$data_relasi->c_parent])&&$mapping_unitkerja[$data_relasi->c_parent] != $current_unitkerja->id
                                                (isset($mapping_unitkerja[$data_relasi->c_parent])&&$mapping_unitkerja[$data_relasi->c_parent] != $trunitkerja_id)
                                            ){
                                                continue; //skip ke property berikutnya
                                            }
                                        }

                                        //echo 'PropertyId :'.$data_relasi->trproperty_id.' Parent :'.$data_relasi->c_parent.' Order :'.$data_relasi->c_order.'<br>';

                                        //if($data_relasi->c_order == 1 && $data_relasi->c_parent){
                                        if($data_relasi->c_order && !in_array($data_relasi->c_parent, $printed_parent)){
                                            echo "<tr>";
                                            echo "<td colspan='3'><b>";
                                            ...
                                            echo "</b></td>";
                                            echo "</tr>";
                                            $printed_parent[] = $data_relasi->c_parent;
                                        }
            ...
            <!--                    <div class="contentForm">-->
                                    ...
                                    if($id_tl == '1'){
                                        ...
                                        if(!is_null($data_entry) && $data_entry !=''){
                                        ...
                                        ##
                                        /* chairina if($data->id == '12'){ //Hanya Property KLASIFIKASI
