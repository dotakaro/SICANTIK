...
//     $jam = date("H:i:s A");
		...
		$this->rat->log('Save',4,$this->session->userdata('id_auth'),$this->input->post('id_daftar'));
...
//              $jam = date("H:i:s A");
				...
				$this->rat->log('Save',3,$this->session->userdata('id_auth'),$this->input->post('id_permohonan'));
            }
...
//                ));
        ...
        if ($update)
            $this->permohonan->where('id', $this->input->post('id_permohonan'))->update(array(
                'd_survey' => $survey->date = $this->input->post('survey')
            ));
		...
		$this->rat->log('Update',3,$this->session->userdata('id_auth'),$this->input->post('id_permohonan'));
