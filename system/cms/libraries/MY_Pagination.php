...
class MY_Pagination extends CI_Pagination {
	...
	public function create_links()
	{
		...
		if ($this->first_link !== FALSE && $this->cur_page > ($this->num_links + 1))
		{
			...
			$output .= $this->first_tag_open.'<a class="first page-numbers" href="'.$first_url.'"'.$attributes.$this->_attr_rel('start').'>'
		...
		if ($this->prev_link !== FALSE && $this->cur_page !== 1)
		{
			...
			{
				$output .= $this->prev_tag_open.'<a class="prev page-numbers" href="'.$this->first_url.$query_string.'"'.$attributes.$this->_attr_rel('prev').'>'
					.$this->prev_link.'</a>'.$this->prev_tag_close;
			}
			else
			{
				$append = ($i === $base_page) ? $query_string : $this->prefix.$i.$this->suffix;
				$output .= $this->prev_tag_open.'<a class="prev page-numbers" href="'.$this->base_url.$append.'"'.$attributes.$this->_attr_rel('prev').'>'
					.$this->prev_link.'</a>'.$this->prev_tag_close;
			}
		...
		if ($this->display_pages !== FALSE)
		{
			...
			for ($loop = $start -1; $loop <= $end; $loop++)
			{
				...
				if ($i >= $base_page)
				{
					...
					{
						$output .= $this->cur_tag_open.'<a href="#" class="page-numbers current">'.$loop.'</a>'.$this->cur_tag_close; // Current page
					}
					else
					{
						$n = ($i === $base_page) ? '' : $i;
						...
						{
							$output .= $this->num_tag_open.'<a class="page-numbers" href="'.$this->first_url.$query_string.'"'.$attributes.$this->_attr_rel('start').'>'
								.$loop.'</a>'.$this->num_tag_close;
						}
						else
						{
							$append = ($n === '') ? $query_string : $this->prefix.$n.$this->suffix;
							$output .= $this->num_tag_open.'<li><a class="page-numbers" href="'.$this->base_url.$append.'"'.$attributes.$this->_attr_rel('start').'>'
		...
		if ($this->next_link !== FALSE && $this->cur_page < $num_pages)
		{
			...
			$output .= $this->next_tag_open.'<a class="next page-numbers" href="'.$this->base_url.$this->prefix.$i.$this->suffix.'"'.$attributes
		...
		if ($this->last_link !== FALSE && ($this->cur_page + $this->num_links) < $num_pages)
		{
			...
			$output .= $this->last_tag_open.'<a class="last page-numbers" href="'.$this->base_url.$this->prefix.$i.$this->suffix.'"'.$attributes.'>'
