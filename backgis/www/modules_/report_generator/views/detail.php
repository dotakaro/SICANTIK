...
$(document).ready(function() {
	...
	function addNewRowDetail(){
		if(numRowDet!='0'){
			...
			row+='<td><input type="button" class="btn_detail_condition ui-widget-content" value="Kondisi" disabled="true"/></td>';
	...
	function add_combogrid_field(){
		$( ".combo_grid_field").each(function(){
			...
			$(selector).combogrid({
			    searchButton:true,
          		otherParam:otherParameters,
				colModel: [{'columnName':'column_name','width':'45','label':'Nama Tabel','align':'left'}],
...
<div id="content">
	...
	?>
		<div class="entry">
			...
			<br style="clear: both" />
			<?php
				echo form_label('<i>Query</i> Grup');
			...
			<div id="tab_detail">
                <ul>
                    <li><a href="#tabdetail-1"><b>Tabel</b></a></li>
                    <li><a href="#tabdetail-2"><b>Kolom</b></a></li>
                    <li><a href="#tabdetail-3"><b>Kondisi</b></a></li>
                </ul>
                <div id="tabdetail-1">
					<?php 
						$add_group = array(
					...
					<table id="tbl_table_detail" class="report_generator" cellspacing="0" cellpadding="0" border="1">
						<thead>
							<tr>
							<th width="150px">Tabel Laporan</th>
							<th width="150px">Tipe <i>join</i> Laporan</th>
						...
						<td>
							...
							<input type="button" <?php echo $disable_condition;?> value="Kondisi" class="btn_detail_condition ui-widget-content"/>
							<?php } ?>
						</td>
						<td>
							<?php if($x!=0){?>
				...
				<div id="tabdetail-2">	
					...
					<table id="tbl_field" class="report_generator" cellspacing="0" cellpadding="0" border="1">
						<thead>
							<tr>
							<th width="250px">Tabel Laporan</th>
							<th width="250px">Kolom Laporan</th>
							<th width="250px"><i>Alias</i> Kolom Laporan</th>
						...
						<td><input type="text" class="required" name="data[ReportField][<?php echo $x;?>][field_alias]" value="<?php echo $report_field->field_alias;?>"/></td><td><input type="button" value="Hapus" class="btn_delete_detail ui-widget-content"></td>
						</tr>						
						<?php $x++;endforeach;?>
						</tbody>
					</table>
