...
<div id="content">
    <div class="post">
		...
		<?php
            ...
            echo form_open('report_component/edit/', $attr);
		?>
		<div class="entry">
            <div id="tabs">
                <ul>
				...
				echo form_dropdown('data[ReportComponent][trperizinan_id]', $option_perizinan,$report_component_data->trperizinan_id,'id="ReportComponentTrperizinanId" class="required-option input-select-wrc"');
				?>
				<br style="clear: both" />
                ...
                echo form_dropdown('data[ReportComponent][trunitkerja_id]', $opsiUnitKerja, $report_component_data->trunitkerja_id,'class = "input-select-wrc required-option" id="ReportGeneratorTrunitkerjaId"');
                ?>
                <br style="clear: both" />

				<?php
				echo form_label('Tipe Laporan');
				echo form_dropdown('data[ReportComponent][report_type]', $option_report_type,$report_component_data->report_type,'id="ReportComponentReportType" class="input-select-wrc"');
				?>
				<br style="clear: both" />								
				</div>
				<div id="tabs-2">
