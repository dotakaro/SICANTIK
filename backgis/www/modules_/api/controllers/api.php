...
//            echo $nomor_pendaftaran;exit();
	...
	public function jenisPerizinanTarifList_get() {
        $perizinan = new trperizinan();
        $list_perizinan = $perizinan->where_related_trkelompok_perizinan('id',4)->order_by('n_perizinan','ASC')->get();
...
//    }
    ...
    public function register_post(){
        ...
        if (!$this->post('jenis_identitas') || !$this->post('id_pemohon') || !$this->post('nama_pemohon') ||
