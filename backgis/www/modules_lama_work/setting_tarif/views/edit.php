                ...
                <div id="tabs-2">
                    ...
                    ?>
                     <table id="tbl_group" class="display" cellspacing="0" cellpadding="0" border="1">
                        ...
                        <tbody>
                            <?php
                            foreach($existing_tarif_kategori as $key=>$tarif_kategori){
                            ?>
                                <tr>
                                <td><input name="SettingTarifHarga[<?php echo $key;?>][kategori]" class="required" style="width:100%" value="<?php echo $tarif_kategori->kategori;?>"/></td>
                                <td><input name="SettingTarifHarga[<?php echo $key;?>][harga]" class="required" style="width:100%" value="<?php echo $tarif_kategori->harga;?>"/></td>
                                <td>
                                    <input type="button" class="btn_delete ui-widget-content" value="Hapus"/>
                                    <input type="hidden" name="SettingTarifHarga[<?php echo $key;?>][id]" class="setting_tarif_harga_id" value="<?php echo $tarif_kategori->id;?>"/>
                                </td>
                                </tr>
                            <?php
                            }
