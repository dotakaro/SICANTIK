    ...
    <div class="post">
		...
		<div class="entry">
            <div id="tabs">
				...
				echo form_dropdown('data[ReportGenerator][trperizinan_id]', $option_perizinan,$report_data->trperizinan_id,'id="ReportGeneratorTrperizinanId" class="input-select-wrc required-option"');
				?>
				<br style="clear: both" />		
				<?php
				echo form_label('Report Type');
				echo form_dropdown('data[ReportGenerator][report_type]', $option_report_type,$report_data->report_type,'id="ReportGeneratorReportType" class="input-select-wrc required-option"');
				?>
				<br style="clear: both" />
				...
				<div id="tabs-2">
					...
					<table id="tbl_group" class="display" cellspacing="0" cellpadding="0" border="1">
						...
						<tbody>
							...
							<td>
								<select class="use_direct_query required" name="data[ReportGroupData][<?php echo $x;?>][use_direct_query]"><?php echo $directQueryList;?></select><input type="button" <?php echo $disable_query;?> value="Query" class="btn_query ui-widget-content"/><input type="hidden" name="data[ReportGroupData][<?php echo $x;?>][direct_query]" value="<?php echo $report_group_data->direct_query;?>"/>
							</td>
							<td>
								<input type="button" value="Detail" class="btn_detail ui-widget-content" <?php echo $disable_detail;?>/><input type="button" value="Hapus" class="btn_delete ui-widget-content"/><input type="hidden" class="report_group_data_id" name="data[ReportGroupData][<?php echo $x;?>][id]" value="<?php echo $report_group_data->id;?>"/>
								</td>
							</tr>
							<?php 
								$x++;
